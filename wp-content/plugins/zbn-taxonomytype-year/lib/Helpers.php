...
use BN\TaxonomyYear\ViewRenderer;
class Helpers {
    ...
    private static function getPluginPath() {
        ...
        return substr( BN_TAXONOMYYEAR_PLUGIN_FILE, strpos( BN_TAXONOMYYEAR_PLUGIN_FILE, $pluginsPath ) + strlen( $pluginsPath ) );
    }
    public static function getDefaultSettings() {
        $defaultSettings = require( plugin_dir_path(BN_TAXONOMYYEAR_PLUGIN_FILE) . 'settings.php' );
        return $defaultSettings;
    }
    public static function pluginUrl( $uri = '' ) {
        return apply_filters( 'bn_taxonomytype_year_plugin_url', plugins_url( $uri, BN_TAXONOMYYEAR_PLUGIN_FILE ), $uri );
    }
