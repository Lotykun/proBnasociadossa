...
//  C:\Inetpub\vhosts\bnasociadossa.es\httpsdoc\wp-content\maintenance\template.phtml
...
<head>
    ...
    <link rel="stylesheet" href="http://bnasociadossa.es/wp-content/maintenance/assets/styles.css">
    <script src="http://bnasociadossa.es/wp-content/maintenance/assets/timer.js"></script>
...
<body>
    ...
    <section class="social-links">
                ...
                <span class="icon"><img src="http://bnasociadossa.es/wp-content/maintenance/assets/images/facebook.svg" alt="Facebook"></span>
            </a>
                    <a class="social-links__link" href="https://twitter.com/Plesk" target="_blank" title="Twitter">
                <span class="icon"><img src="http://bnasociadossa.es/wp-content/maintenance/assets/images/twitter.svg" alt="Twitter"></span>
            </a>
            </section>
